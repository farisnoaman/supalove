...
export default function OrgNewProjectPage() {
        ...
        <div className="max-w-2xl mx-auto space-y-8 py-8 px-4">
            ...
            <div className="bg-card border rounded-xl p-8 shadow-sm">
                <div className="mb-6">
                    ...
                    <p className="text-sm text-muted-foreground">Creating in <span className="font-bold text-foreground">{currentOrg?.name}</span></p>
                </div>
                ...
                {!success ? (
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <button
                            onClick={() => router.push(`/projects/${resultData?.id}`)} // Or stay in org view? Probably manage. But manage is at /projects/[id].
