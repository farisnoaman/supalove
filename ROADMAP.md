...
- [x] Persist projects in control-plane DB
- [x] Inject secrets (JWT, DB passwords)
- [ ] Replace shell scripts with Coolify API
- [x] Add Auth service (Keycloak/GoTrue)
- [x] Add Storage (MinIO)
- [x] Add Realtime (Supabase Realtime)
- [x] Add Dashboard UI (In Progress)
- [x] Add API Gateway (Nginx)
